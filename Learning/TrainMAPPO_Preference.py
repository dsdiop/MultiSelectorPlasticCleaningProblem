...
from Learning.utils import make_env, PreferenceMAPPOAgent
...
def parse_args():
    ...
    parser.add_argument("--learning-rate", type=float, default=1e-3, ################################################### valor anterior 2.5e-4
    ...
    parser.add_argument("--ent-coef", type=float, default=0.1,  ################################################### valor anterior 0.01
...
if __name__ == "__main__":
    ...
    agent = PreferenceMAPPOAgent(env_for_shapes).to(device)
    ...
    logprobs = torch.zeros((args.num_steps, args.num_envs, N), device=device)
