...
arch = 'v1'
policy_name = f'Experimento_clean25_{args.map}_{args.benchmark}_random_nus_nsteps5'
logdir=f'./Learning/runs/Vehicles_{N}/SecondPaper/seq_nu_2experiment/{args.map}_{args.benchmark}'
...
if __name__ == "__main__":
    ...
    nu_steps.reverse()
    nu_steps = [0.1,0.0]
    initial_network = logdir +'/seq_nu_2experiment_0.2'
    eps = 10000
    for nu_step in nu_steps:
        policy_name = "seq_nu_2experiment_" + str(nu_step)
        ...
        eps = 2000
        multiagent.run_episodes(episodes=eps,render = True)
